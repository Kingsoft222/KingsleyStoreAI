...
// FIXED: Clean object format to stop the "Bad control character" error
const INTERNAL_KEY = {
...
exports.handler = async (event) => {
    ...
    try {
        ...
        // This uses the clean object above
        ...
        return {
            statusCode: 200,
            headers,
            body: JSON.stringify({ outputImage: `data:image/png;base64,${response.data.predictions[0].bytesBase64Encoded}`, status: "success" })
        };
    } catch (e) {
        return { statusCode: 500, headers, body: JSON.stringify({ error: "Final hurdle! Re-try now.", details: e.message }) };
    }
};
...
exports.handler = async (event) => {
    ...
    try {
        ...
        // This is the clean key string - no extra characters outside the backticks
        ...
        const response = await axios.post(apiURL, {
            instances: [{
                prompt: `A high-quality fashion photo. Change the clothing of the person to a luxury ${cloth}. Realistic fabric and lighting.`,
        ...
        return { 
            statusCode: 500, 
            headers, 
            body: JSON.stringify({ error: "Build Successful, but AI failed", details: error.message }) 
        };
    }
};
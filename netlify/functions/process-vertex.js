...
// Using JSON.parse to ensure the \n characters are decoded correctly
const INTERNAL_KEY = JSON.parse(`{
...
exports.handler = async (event) => {
    ...
    try {
        ...
        return { statusCode: 500, headers, body: JSON.stringify({ error: "Decoding issue fixed. Re-trying...", details: e.message }) };
    }
};
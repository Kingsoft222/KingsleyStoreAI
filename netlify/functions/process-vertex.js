...
exports.handler = async (event) => {
    ...
    try {
        ...
        const cleanBase64 = face.includes('base64,') ? face.split('base64,').pop() : face;
        ...
        const response = await axios.post(apiURL, {
            instances: [{
                prompt: `A man wearing a ${cloth || 'senator native outfit'}. Studio quality.`,

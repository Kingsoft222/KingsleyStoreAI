...
exports.handler = async (event) => {
    ...
    try {
        ...
        // THE CLEANED KEY: No dangling strings, no syntax errors
        ...
        const credentials = {
            ...
            // This fix is crucial: it converts the text "\n" into real line breaks
        ...
        const response = await axios.post(apiURL, {
            instances: [{
                prompt: `A high-quality fashion photo. Change the clothing of the person to a luxury ${cloth}. Realistic fabric textures.`,

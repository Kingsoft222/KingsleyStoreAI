...
exports.handler = async (event) => {
    ...
    try {
        ...
        // THE BULLETPROOF KEY: Using a raw string to bypass all formatting issues
        ...
        const credentials = {
            ...
            // This line ensures the key is interpreted exactly as intended
        ...
        const response = await axios.post(apiURL, {
            instances: [{
                prompt: `A professional high-fashion photo. The person in the photo is wearing a luxury ${cloth}. Realistic high-quality fabric and lighting.`,
        ...
        console.error("LOG_ENTRY:", error.message);
        return { 
            statusCode: 500, 
            headers, 

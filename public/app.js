...
const clothesCatalog = [
    { id: 1, name: "Premium Red Senator", tags: "senator red native traditional", img: "senator_red.jpg", price: "₦25k", cat: "Native" },
    { id: 2, name: "Blue Ankara Suite", tags: "ankara blue native traditional", img: "ankara_blue.jpg", price: "₦22k", cat: "Native" },
    { id: 3, name: "Classic White Polo", tags: "white polo shirt corporate top", img: "white_polo.jpg", price: "₦10k", cat: "Corporate" },
    { id: 4, name: "Urban Baggy Jeans", tags: "jeans denim baggy casual pants blue", img: "baggy_jeans.jpg", price: "₦28k", cat: "Casual" },
    { id: 5, name: "Royal Bridal Gown", tags: "wedding gown bridal dress white long gown", img: "wedding_gown.jpg", price: "₦150k", cat: "Bridal" }
];
...
window.executeSearch = () => {
    ...
    const matched = clothesCatalog.filter(item => {
        ...
        return item.name.toLowerCase().includes(input) || tagList.includes(input);
    });
    ...
    `).join('') : `<p style="color:#555; grid-column:1/-1;">No ${input} found.</p>`;
};
...
window.startTryOn = async () => {
    ...
    resultDiv.innerHTML = `
        <div style="padding:40px; text-align:center;">
            ...
            <p style="color:#888; margin-top:15px; font-weight:bold;">Stitching your look...</p>
        </div>
    `;
    ...
    try {
        ...
        if (result.success) {
            const msg = encodeURIComponent(`Hi Kingsley, I want to order ${selectedCloth.name}`);
            resultDiv.innerHTML = `
                <div style="width:100%; display:flex; justify-content:flex-end; margin-bottom:10px;">
                    <span onclick="window.closeFittingRoom()" style="color:#e60023; font-weight:bold; cursor:pointer; font-size:0.85rem;">try another look</span>
                </div>
                <img src="data:image/jpeg;base64,${result.image}" style="width:100%; border-radius:15px; margin-bottom:15px; border: 1px solid #eee;">
                <button onclick="window.open('https://wa.me/${ADMIN_PHONE}?text=${msg}')" class="primary-btn" style="background:#28a745; color:white;">add to cart 🛍️</button>
            `;
...
window.handleUserFitUpload = (e) => { /* Auto starts on profile upload */ };

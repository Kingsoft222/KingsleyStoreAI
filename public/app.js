...
// --- 🎯 RESTORED AUTOMATIC UPLOAD LOGIC ---
window.handleCustomerUpload = (e) => {
    ...
    reader.onload = (ev) => { 
        ...
        window.startTryOn(); // ⚡ AUTOMATICALLY TRIGGERS PROCESSING
    }; 
...
window.proceedToUpload = () => {
    document.getElementById('ai-fitting-result').innerHTML = `
        <div style="text-align:center;">
            ...
            <button onclick="document.getElementById('temp-tryon-input').click()" style="background:#111; color:white; padding:18px; width:100%; border-radius:14px; font-weight:bold; border:none; cursor:pointer;">SELECT PHOTO</button>
        </div>`;
};

...
const ADMIN_PHONE = "2348000000000"; // REPLACE WITH YOUR REAL NUMBER
...
async function resizeImage(base64Str) {
    return new Promise((resolve) => {
        ...
        img.onload = () => {
            ...
            // Optimized 3:4 ratio for full-body coverage (inc. shoes)
            canvas.width = 768;
            canvas.height = 1024;
...
async function getBase64FromUrl(url) {
    ...
    if (!response.ok) throw new Error(`Image ${url} not found in folder.`);

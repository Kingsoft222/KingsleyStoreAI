// --- 🎯 SIDEBAR NAVIGATOR (FIXED CHAT & THEME) ---
window.openOptionsMenu = () => {
    ...
    document.getElementById('ai-fitting-result').innerHTML = `
        <div id="sidebar-drawer" style="width:280px; height:100%; background:#ffffff; position:fixed; left:0; top:0; z-index:10001; padding:20px; box-shadow:2px 0 10px rgba(0,0,0,0.1); color: #111; border-radius: 0;">
            
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:30px;">
                <span onclick="window.openChatPage()" style="color:#0b57d0; font-weight:700; cursor:pointer; font-size:0.9rem; display:flex; align-items:center; gap:5px;">🎧 Chat Support</span>

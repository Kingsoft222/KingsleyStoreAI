...
export default async function handler(req, res) {
    ...
    try {
        ...
        // --- THE ACTUAL FIX: Strip headers for the new API ---
        ...
        // Keep your original category logic exactly as it was
        ...
        const response = await axios.post(url, {
            instances: [{
                image: { bytesBase64Encoded: cleanUser }, // Updated key name
                clothes: [{ 
                    image: { bytesBase64Encoded: cleanCloth }, // Updated key name
        ...
        // Vertex now often nests the response in an 'image' object
